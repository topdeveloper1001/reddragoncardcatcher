...
namespace RedDragonCardCatcher.Common.Log
{
    ...
    public static class LogProvider
    {
        ...
        private static IRDCCLog internalLog = new InternalLog();
        ...
        public static void SetCustomLogger(IRDCCLog customLog)
        {
        ...
        /// </summary>
        private class InternalLog : IRDCCLog
        {
